...
- sync your own `pass` repo to Android using **SSH**
- import your **GPG key securely**
- enable **browser autofill**, without third-party vault services

Here’s a concise, plain Markdown blog post draft.
